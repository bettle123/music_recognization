...
def acc(allInfo_symbol, true_label_file, classes, filename, t_acc_matrix, model_name):
    ...
    record = ["filename", basefilename, "model_name", model_name, "Total_symbols", total, "Total_predict_correct_symbols", correct, "Total_precision", (correct/total)];
    ...
    if (len(basefilename)>5):
        store = "../Output/Predict_Output/0117_test/ConfusionMatrix/CM_"+basefilename[0:2]+".csv";
    else:
        store = "../Output/Predict_Output/0117_test/ConfusionMatrix/CM_"+basefilename[0]+".csv";
    ...
    store_img = "";
    if (len(basefilename)>5):
        store_img = "../Output/Predict_Output/0117_test/Result/barplot_"+basefilename[0:2]+".png";
    else:
        store_img = "../Output/Predict_Output/0117_test/Result/barplot_"+basefilename[0]+".png";
