...
def main():
    ...
    '''
    for i in range(0, 10):
        tmp = "../sample/camera_photo/0117_test/"+str(i+1)+".jpg";
        filename.append(tmp);
    '''
    tmp = "../sample/camera_photo/0117_test/1.jpg";
    filename.append(tmp);
    tmp = "../sample/camera_photo/0117_test/7.jpg";
    filename.append(tmp);
    ...
    true_label_file = [];
    tmp = "../sample/true_label/0117_test/1_true_label_5_classes.csv";
    true_label_file.append(tmp);
    tmp = "../sample/true_label/0117_test/7_true_label_5_classes.csv";
    true_label_file.append(tmp);
    
    '''
    for i in range(0, 10):
        tmp = "../sample/true_label/0117_test/"+str(i+1)+"_true_label_5_classes.csv";
        true_label_file.append(tmp);
    '''
